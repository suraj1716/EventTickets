...
> = {
  ...
  cancelled: {
    fg: "#e08585",
    bg: "rgba(224,133,133,0.08)",
    border: "rgba(224,133,133,0.3)",
  },
  refunded: {
    fg: "#e08585",
    bg: "rgba(224,133,133,0.08)",
    ...
    padding-left: 16px;
      ...
      <div style={{ minHeight: "100vh", background: C.bg, color: C.text }}>
        <PageHero
          ...
          subtitle="View your purchased tickets and scan codes at the door."
        />
        <div className="max-w-3xl mx-auto px-6 sm:px-6 lg:px-1 py-12">
          {tickets.length === 0 ? (
            <div
              style={{
                borderRadius: 14,
                        ...
                        <div style={{ minWidth: 0, paddingLeft: 8 }}>
                          ...
                          {ticket.last_resale && (
                            ...
                            >
                              ...
                              {ticket.last_resale.seller_name
                                ? ` � from ${ticket.last_resale.seller_name}`
                                : ""}
                            </p>
                          )}
