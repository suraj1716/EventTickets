...
'legs.venue:id,notes',
                    ...
                    'legs.seats:id,event_leg_id,venue_seat_id,venue_section_id,ticket_tier_id,label,row_label,seat_number,sort_order,status',
                    'legs.seats.section:id,name,code,sort_order',
